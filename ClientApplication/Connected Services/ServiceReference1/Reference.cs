...
namespace ClientApplication.ServiceReference1 {
    ...
    public interface WebService1Soap {
        ...
        ClientApplication.ServiceReference1.Hotel[] rechercherChambre(string ville, string checkIn, string checkout, int prixmin, int prixmax);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/rechercherChambre", ReplyAction="*")]
        System.Threading.Tasks.Task<ClientApplication.ServiceReference1.Hotel[]> rechercherChambreAsync(string ville, string checkIn, string checkout, int prixmin, int prixmax);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WebService1SoapChannel : ClientApplication.ServiceReference1.WebService1Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WebService1SoapClient : System.ServiceModel.ClientBase<ClientApplication.ServiceReference1.WebService1Soap>, ClientApplication.ServiceReference1.WebService1Soap {
        ...
        public ClientApplication.ServiceReference1.Hotel[] rechercherChambre(string ville, string checkIn, string checkout, int prixmin, int prixmax) {
            return base.Channel.rechercherChambre(ville, checkIn, checkout, prixmin, prixmax);
        }
        
        public System.Threading.Tasks.Task<ClientApplication.ServiceReference1.Hotel[]> rechercherChambreAsync(string ville, string checkIn, string checkout, int prixmin, int prixmax) {
