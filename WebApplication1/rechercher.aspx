      ...
      <form>
        ...
        <div class="inner-form">
          ...
          <div class="input-field second-wrap">
            ...
            <input id="prixMin" type="text" placeholder="Prix min/nuit" />
          </div>
          <div class="input-field second-wrap">
            <div class="icon-wrap">
             <svg viewBox="0 0 320 512" role="img" class="svg-inline--fa fa-euro-sign fa-w-10" data-icon="euro-sign" data-prefix="fas" focusable="false" aria-hidden="true" 
            ...
            <input id="prixMax" type="text" placeholder="Prix max/nuit" />
          </div>
          <div class="input-field first-wrap">
            <div class="icon-wrap">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <input class="datepicker" id="depart" type="text" placeholder="Choisissez vos dates de séjour" />
          </div>
        <!--  <div class="input-field fouth-wrap">
          ...
          <div class="input-field fifth-wrap">
            <button class="btn-search" id="btnSearch" type="button">SEARCH</button>
          </div>
        </div>
      </form>
    </div>
